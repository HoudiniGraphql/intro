...
export class Record {
	...
	forgetSubscribers_walk(targets, visited = []) {
		...
		for (const linkedRecordID of linkedIDs) {
			...
			(_a = this.cache.internal.getRecord(linkedRecordID)) === null || _a === void 0
				? void 0
				: _a.forgetSubscribers_walk(targets, visited);
		}
	}
	removeSubscribers(fields, sets) {
		...
		for (const fieldName of fields) {
			...
			for (const set of sets) {
				...
				if (
					!((_a = this.referenceCounts[fieldName]) === null || _a === void 0 ? void 0 : _a.has(set))
				) {
					continue;
				}
